...
class StaggeredDotsWaveAnimation extends StatefulWidget {
  final double size;
  final Color color;
  ...
  @override
  State<StaggeredDotsWaveAnimation> createState() => _StaggeredDotsWaveState();
}

class _StaggeredDotsWaveState extends State<StaggeredDotsWaveAnimation>
