            ...
            return InkWell(
              ...
              onTap: () {
                ...
                _detailsOrderVertexController
                    .getDetailsAndCommentsOrderByID(itemOrder.idOrder);
                //
              ...
              child: ItemOrderWidgetClass(
                ...
                stateText: MethodsClassUTls.translateStateOrderToArabic(
                    itemOrder.orderState),
                colorBox:
                    MethodsClassUTls.colorItemListOrder(itemOrder.orderState),
                colorState:
                    MethodsClassUTls.colorItemListOrder(itemOrder.orderState),
              ),
            );
